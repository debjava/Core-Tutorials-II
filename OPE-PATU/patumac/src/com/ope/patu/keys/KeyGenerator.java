...
//	
//		// KVV 8 bytes
////		byte[] temp = DESUtil.getEncryptedBytes(secretKey);
//		
//		byte[] temp = DESUtil.getEncryptedBytes( kekBytes,secretKey );
//		
//		// Convert the kvv into string
//		String kvv = CommonUtil.bytesToHex( temp );
//
...
//	}
	...
	{
		String kekPart1 = getKEKPart1();
		String kekPart2 = getKEKPart2();
		System.out.println("Part1-------"+kekPart1);
		System.out.println("Part1-------"+kekPart2);
		String kekString = generateKEK( kekPart1 , kekPart2 );
		System.out.println("kekString-----"+kekString);
		String kvvString = getKVV(kekString);
		System.out.println("kvv String-----"+kvvString);
		/*
		 * For the first time, pass new kek as null
		 * For the second time, pass the new kek
		 */
		String newKekString = null;
		String aukString = getAUK( kekString, newKekString );
		System.out.println("AUK String-------"+aukString);
	}
}
