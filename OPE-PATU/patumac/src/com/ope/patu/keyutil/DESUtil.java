...
public class DESUtil 
{
	...
	private static String algorithmSpec = "DES/CBC/NoPadding";//"DES/ECB/NoPadding"
	...
	public static byte[] getEncryptedBytes2(byte[] bytes, SecretKey secretKey)
	{
		byte[] encryptedBytes = null;
		try 
		{
	 ...
	 * Another way
	 */
	public static byte[] getEncryptedBytes1(byte[] bytes, SecretKey secretKey)
	{
		byte[] encryptedBytes = null;
		try 
		{
